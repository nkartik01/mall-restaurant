...
export default class Payment extends Component {
  ...
  getBill = async () => {
    try {
      var bill = await axios.get("http://192.168.1.178:5001/mall-restraunt/us-central1/api/bill/getBill/" + this.props.bill, {
      ...
      <div>
        <form
          onSubmit={async (e) => {
            ...
            e.preventDefault();
            await axios.post(
              "http://192.168.1.178:5001/mall-restraunt/us-central1/api/bill/addDiscount",
              {
        ...
        <form
          onSubmit={async (e) => {
            ...
            try {
              ...
              await axios.post(
                "http://192.168.1.178:5001/mall-restraunt/us-central1/api/bill/byCard",
                {
                  // amount: this.props.table.partial ? partAmont) : this.props.table.orderHistory.sum,
