...
export default withRouter(
  class ManipulateRFID extends Component {
    ...
    getCard = async (e) => {
      try {
        e.preventDefault();
        var res = await axios.get("http://192.168.1.106:5001/mall-restraunt/us-central1/api/card/getCard/" + this.state.uid, {
    ...
    assign = async (e) => {
      ...
      try {
        await axios.post(
          "http://192.168.1.106:5001/mall-restraunt/us-central1/api/card/assign",
          {
            uid: this.state.uid,
    ...
    retire = async (e) => {
      ...
      try {
        await axios.post(
          "http://192.168.1.106:5001/mall-restraunt/us-central1/api/card/retire",
          { uid: this.state.uid },
          { headers: { "x-auth-token": localStorage.getItem("token") } }
        );
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    var res = await axios.post(
                      "http://192.168.1.106:5001/mall-restraunt/us-central1/api/card/addAmount",
